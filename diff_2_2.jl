...
println(r_μ_2_1_diff_ss)

# Generate code
# generate_eT_code("mu_3_H_nu_1_s", "mu_4_H_nu_1_s", r_μ_2_1_diff_s, "rho_aibj", [4, 3, 6, 5], trans, "doublet_ccsd")
generate_eT_code("jacobian_diff_doubles_doubles", "jacobian_diff_doubles_doubles", r_μ_2_1_diff_ss, "rho_aibj", [4, 3, 6, 5], trans, "doublet_ccsd")
