   subroutine omega_μ2_4_ss_doublet_ccsd(wf, omega_bjck, gAxAx_vv, g_oooo, g_ovov, g_vvvv, gxIxI_oo, tAIAx_o, tAIxx_vo, tAxAx_oo, tAxxI_ov, tAxxx_ovo, t_vovo, txIxI_vv, txIxx_vvo, txxxI_vov, uAIxx_vo, uAxxx_ovo, uxIxx_vvo, uxxxI_vov)
!!
!! Generated function
!!
      implicit none
...
!
      call dgemm('T', 'T', &
         ...
         wf%n_o)
!
      call mem%alloc(X8, wf%n_o, wf%n_v, wf%n_v, wf%n_v)
      call sort_to_1243(X7, X8, wf%n_o, wf%n_v, wf%n_v, wf%n_v)
      call mem%dealloc(X7)
...
!
      call mem%dealloc(X8)
      call add_1243_to_1234(one, X9, omega_bjck, wf%n_o, wf%n_v, wf%n_o, wf%n_v)
      call mem%dealloc(X9)
...
!
      ...
      call mem%alloc(X12, wf%n_o, wf%n_o, wf%n_v, wf%n_v)
!
      call dgemm('T', 'T', &
         wf%n_v*wf%n_o**2, &
         wf%n_v, &
...
!
      ...
      call add_1342_to_1234(one, X12, omega_bjck, wf%n_o, wf%n_v, wf%n_o, wf%n_v)
      call mem%dealloc(X12)
      call mem%alloc(X13, wf%n_o, wf%n_v, wf%n_v, wf%n_v)
!
      call dgemm('N', 'T', &
         wf%n_o, &
         wf%n_v**3, &
         ...
         wf%n_o)
!
      call mem%alloc(X14, wf%n_o, wf%n_v, wf%n_v, wf%n_v)
      call sort_to_1243(X13, X14, wf%n_o, wf%n_v, wf%n_v, wf%n_v)
...
!
      ...
      call add_1243_to_1234(one, X15, omega_bjck, wf%n_o, wf%n_v, wf%n_o, wf%n_v)
...
!
      ...
      call mem%alloc(X19, wf%n_v, wf%n_v, wf%n_v, wf%n_o)
!
      call dgemm('N', 'N', &
         wf%n_v**3, &
         wf%n_o, &
         ...
         wf%n_v**3)
!
      call mem%alloc(X20, wf%n_v, wf%n_o, wf%n_v, wf%n_v)
      call sort_to_1432(X19, X20, wf%n_v, wf%n_v, wf%n_v, wf%n_o)
...
!
      ...
      call sort_to_1243(g_oooo, X21, wf%n_o, wf%n_o, wf%n_o, wf%n_o)
...
!
      ...
      call mem%alloc(X23, wf%n_o, wf%n_o, wf%n_v, wf%n_v)
!
      call dgemm('T', 'T', &
         wf%n_v*wf%n_o**2, &
         wf%n_v, &
...
!
      ...
      call add_1342_to_1234(one, X23, omega_bjck, wf%n_o, wf%n_v, wf%n_o, wf%n_v)
      call mem%dealloc(X23)
      call mem%alloc(X24, wf%n_o, wf%n_v, wf%n_v)
      call sort_to_312(txIxx_vvo, X24, wf%n_v, wf%n_v, wf%n_o)
...
!
      ...
      call sort_to_132(txIxx_vvo, X26, wf%n_v, wf%n_v, wf%n_o)
...
!
      ...
      call mem%alloc(X28, wf%n_v, wf%n_v, wf%n_o)
!
      call dgemm('T', 'T', &
         wf%n_v, &
         wf%n_v*wf%n_o, &
         ...
         wf%n_v)
!
      call mem%alloc(X29, wf%n_o, wf%n_v, wf%n_v)
      call sort_to_312(txIxx_vvo, X29, wf%n_v, wf%n_v, wf%n_o)
...
!
      ...
      call mem%alloc(X39, wf%n_o, wf%n_v, wf%n_o)
!
      call dgemm('N', 'N', &
         wf%n_o, &
         wf%n_v*wf%n_o, &
...
!
      ...
      call mem%alloc(X41, wf%n_o, wf%n_o, wf%n_v)
      call sort_to_132(tAxxx_ovo, X41, wf%n_o, wf%n_v, wf%n_o)
...
!
      ...
      call sort_to_1342(X56, X57, wf%n_o, wf%n_v, wf%n_o, wf%n_o)
...
!
      ...
      call mem%alloc(X66, wf%n_o, wf%n_o, wf%n_v, wf%n_o)
!
      call dgemm('T', 'T', &
         wf%n_o, &
         wf%n_v*wf%n_o**2, &
...
!
      ...
      call sort_to_1423(X66, X67, wf%n_o, wf%n_o, wf%n_v, wf%n_o)
...
!
      ...
      call mem%alloc(X75, wf%n_o, wf%n_o, wf%n_v, wf%n_v)
!
      call dgemm('T', 'T', &
         wf%n_v*wf%n_o**2, &
         wf%n_v, &
...
!
      ...
      call add_1342_to_1234(one, X75, omega_bjck, wf%n_o, wf%n_v, wf%n_o, wf%n_v)
...
!
      ...
      call sort_to_1342(g_ovov, X81, wf%n_o, wf%n_v, wf%n_o, wf%n_v)
...
!
      ...
      call mem%alloc(X85, wf%n_o, wf%n_o, wf%n_v, wf%n_v)
!
      call dgemm('T', 'N', &
         wf%n_v*wf%n_o**2, &
         wf%n_v, &
...
!
      ...
      call add_1342_to_1234(one, X85, omega_bjck, wf%n_o, wf%n_v, wf%n_o, wf%n_v)
      call mem%dealloc(X85)
      call mem%alloc(X86, wf%n_o, wf%n_v, wf%n_o, wf%n_o)
!
      call dgemm('N', 'N', &
         wf%n_v*wf%n_o**2, &
         wf%n_o, &
...
!
      ...
      call sort_to_1342(X86, X87, wf%n_o, wf%n_v, wf%n_o, wf%n_o)
...
!
      ...
      call add_1342_to_1234(one, X90, omega_bjck, wf%n_o, wf%n_v, wf%n_o, wf%n_v)
...
!
      ...
      call mem%alloc(X119, wf%n_v, wf%n_v, wf%n_o)
!
      call dgemm('T', 'T', &
         wf%n_v, &
         wf%n_v*wf%n_o, &
...
!
      ...
      call mem%alloc(X120, wf%n_o, wf%n_v, wf%n_v)
      call sort_to_312(txIxx_vvo, X120, wf%n_v, wf%n_v, wf%n_o)
...
!
      ...
      call sort_to_213(txxxI_vov, X140, wf%n_v, wf%n_o, wf%n_v)
...
!
   end subroutine omega_μ2_4_ss_doublet_ccsd
