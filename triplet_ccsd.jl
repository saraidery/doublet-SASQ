...
E =  project_triplet_equation_on_bra(μ_0, H, 0, T2, 2) |> SpinAdaptedSecondQuantization.simplify
S =  project_triplet_equation_on_bra(μ_0, 1, 0, T2, 2) |> SpinAdaptedSecondQuantization.simplify
...
# @time S_μ1 = project_triplet_equation_on_bra(μ_1, 1, 0, T2, 3) |> SpinAdaptedSecondQuantization.simplify
...
# @time S_2_2 = project_triplet_equation_on_bra(μ_2_2, 1, 0, T2, 1) |> SpinAdaptedSecondQuantization.simplify
...
# @time S_2_4 = project_triplet_equation_on_bra(μ_2_4, 1, 0, T2, 2) |> SpinAdaptedSecondQuantization.simplify
...
# @time S_2_6= project_triplet_equation_on_bra(μ_2_6, 1, 0, T2, 3) |> SpinAdaptedSecondQuantization.simplify
# open("S_2_6.txt", "w") do io
#     println(io, (S_2_6, trans))
# end




# @time O_μ1 = project_triplet_equation_on_bra(μ_1, H, 0, T2, 3) |> SpinAdaptedSecondQuantization.simplify
...
open("O_2_6.txt", "w") do io
    println(io, (O_2_6, trans))
end