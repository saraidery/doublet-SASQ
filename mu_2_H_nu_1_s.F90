   subroutine mu_2_H_nu_1_s_doublet_ccsd(wf, rho_aibj, L_ovoo, L_ovvv, g_oovo, g_ovoo, g_ovvv, g_vvvo, r_vo, u_aibj)
!!
!! Generated function
!!
      implicit none
...
!
      real(dp), dimension(:,:), allocatable :: X7, X10, X11, X12, X13, X14, X16, X17, X20, X21, X36, X40, X49, X57
      real(dp), dimension(:,:,:,:), allocatable :: X1, X2, X3, X4, X5, X6, X8, X9, X15, X18, X19, X22, X23, X24, X25, X26, X27, X28, X29, X30, X31, X32, X33, X34, X35, X37, X38, X39, X41, X42, X43, X44, X45, X46, X47, X48, X50, X51, X52, X53, X54, X55, X56, X58, X59, X60
!
!
