   module subroutine mu_2_H_nu_2_ss_doublet_ccsd(wf, rho_aibj, L_oooo, L_vvvv, g_ovov, r_vovo, u_aibj)
!!
!! Generated function
!!
      implicit none
...
!
      ...
      real(dp), dimension(:,:,:,:), allocatable :: X5, X6, X7, X8, X9, X10, X11, X12, X13, X14, X15, X16, X17, &
      X18, X19, X20, X21, X23
!
      integer :: i1, i2
!
