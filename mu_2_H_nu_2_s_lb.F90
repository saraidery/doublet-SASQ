   module subroutine mu_2_H_nu_2_s_doublet_ccsd(wf, rho_aibj, L_ovov, L_ovvo, g_oovv, g_ovov, g_ovvo, r_vovo, &
      u_aibj)
!!
!! Generated function
!!
...
!
      ...
      real(dp), dimension(:,:,:,:), allocatable :: X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, &
      X14, X15, X16, X17, X18, X19, X20, X21, X22, X23, X25, X27, X28, X29, X30, X31, X32, X34, X35, X36, X37, X38, &
      X39, X41, X42, X43, X44, X45, X46, X48, X49, X51, X52
!
