   subroutine mu_2_H_nu_1_doublet_ccsd(wf, rho_aibj, L_oovo, L_ovoo, L_ovvv, L_vovv, L_vvvo, g_ovoo, g_ovvv, &
r_vo, u_aibj)
!!
!! Generated function
!!
...
!
      real(dp), dimension(:,:), allocatable :: X7, X10, X11, X12, X13, X14, X15, X17, X19, X20, X22, X23, X24, &
X25, X28, X29, X34, X35, X40, X41, X55, X59, X73, X76, X86, X94, X107, X112
      real(dp), dimension(:,:,:,:), allocatable :: X1, X2, X3, X4, X5, X6, X8, X9, X16, X18, X21, X26, X27, &
X30, X31, X32, X33, X36, X37, X38, X39, X42, X43, X44, X45, X46, X47, X48, X49, X50, X51, X52, X53, X54, X56, &
X57, X58, X60, X61, X62, X63, X64, X65, X66, X67, X68, X69, X70, X71, X72, X74, X75, X77, X78, X79, X80, X81, &
X82, X83, X84, X85, X87, X88, X89, X90, X91, X92, X93, X95, X96, X97, X98, X99, X100, X101, X102, X103, X104, &
X105, X106, X108, X109, X110, X111, X113
!
!
