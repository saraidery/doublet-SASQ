   subroutine mu_4_H_nu_1_ss_doublet_ccsd(wf, rho_aibj, FAx_v, FxI_o, L_ovov, L_vovo, gAIAI, gAIxx_ov, gAxAx_oo, gAxAx_vv, gAxxI_vo, g_oooo, g_ovov, g_vvvv, gxIxI_oo, gxIxI_vv, rAIAI, rAxAx_oo, r_vovo, rxIxI_vv, tAIAx_o, tAIxI_v, tAIxx_vo, tAxAx_oo, tAxxI_ov, tAxxx_ovo, t_aibj, txIxI_vv, txIxx_vvo, txxxI_vov, uAIxx_vo, uAxxx_ovo, u_aibj, uxIxx_vvo)
!!
!! Generated function
!!
      implicit none
...
!
      real(dp) :: X3, X4, X5, X6, X20, X22, X23, X24, X28, X29, X31, X33, X34, X35, X42, X46, X59, X62, X90, X93, X96, X99, X102, X105, X107, X110, X112, X115
      real(dp), dimension(:), allocatable :: X89, X92, X95, X98
      real(dp), dimension(:,:), allocatable :: X14, X17, X19, X21, X26, X30, X32, X37, X39, X40, X41, X43, X44, X45, X57, X58, X60, X61, X81, X86, X101, X104, X106, X109, X111, X114, X142, X144, X147, X152, X158, X162, X165, X168, X174, X177, X181, X184, X189, X194, X197
      real(dp), dimension(:,:,:), allocatable :: X78, X79, X80, X83, X84, X85, X88, X91, X94, X97, X148, X149, X150, X153, X154, X155, X157, X161, X166, X169, X176, X180, X185, X186, X187, X190, X191, X195, X198
      real(dp), dimension(:,:,:,:), allocatable :: X1, X2, X7, X8, X9, X10, X11, X12, X13, X15, X16, X18, X25, X27, X36, X38, X47, X48, X49, X50, X51, X52, X53, X54, X55, X56, X63, X64, X65, X66, X67, X68, X69, X70, X71, X72, X73, X74, X75, X76, X77, X82, X87, X100, X103, X108, X113, X116, X117, X118, X119, X120, X121, X122, X123, X124, X125, X126, X127, X128, X129, X130, X131, X132, X133, X134, X135, X136, X137, X138, X139, X140, X141, X143, X145, X146, X151, X156, X159, X160, X163, X164, X167, X170, X171, X172, X173, X175, X178, X179, X182, X183, X188, X192, X193, X196, X199
!
