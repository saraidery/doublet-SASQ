   subroutine omega_μ2_4_s_ccsd(wf, omega_bjck, LAxxx_voo, LAxxx_vvv, L_ovov, L_voov, LxIxx_ooo, LxxxI_vvo, gAIxx_ov, gAxAx_vv, gAxxI_vo, gAxxx_oov, gAxxx_voo, gAxxx_vvv, g_oooo, g_ovov, g_voov, g_vvoo, g_vvvv, gxIxI_oo, gxIxx_ooo, gxIxx_vov, gxxxI_vvo, tAIAx_o, tAIxI_v, tAIxx_vo, tAxAx_oo, tAxxI_ov, tAxxx_ovo, t_vovo, txIxI_vv, txIxx_vvo, txxxI_vov, uAIxx_vo, uAxxx_ovo, uxIxx_vvo, uxxxI_vov)
!!
!! Generated function
!!
      implicit none
...
!
      ...
      call sort_to_312(tAxxx_ovo, X154, wf%n_o, wf%n_v, wf%n_o)
...
!
      call dgemm('N', 'N', &
         ...
         wf%n_v)
!
      call mem%alloc(X161, wf%n_o, wf%n_o, wf%n_v)
      call sort_to_312(uAxxx_ovo, X161, wf%n_o, wf%n_v, wf%n_o)
      call mem%alloc(X162, wf%n_o, wf%n_o, wf%n_v, wf%n_v)
!
      call dgemm('N', 'T', &
         wf%n_o**2, &
         wf%n_v**2, &
...
!
      ...
      call add_1342_to_1234(one, X162, omega_bjck, wf%n_o, wf%n_v, wf%n_o, wf%n_v)
...
!
      ...
      call mem%alloc(X326, wf%n_o, wf%n_v, wf%n_o, wf%n_v)
      call sort_to_1342(X325, X326, wf%n_o, wf%n_v, wf%n_v, wf%n_o)
...
!
      ...
      call mem%alloc(X719, wf%n_o, wf%n_o, wf%n_v, wf%n_v)
      call sort_to_1342(g_ovov, X719, wf%n_o, wf%n_v, wf%n_o, wf%n_v)
      call mem%alloc(X720, wf%n_o, wf%n_o, wf%n_v)
      call sort_to_132(tAxxx_ovo, X720, wf%n_o, wf%n_v, wf%n_o)
      call mem%alloc(X721, wf%n_v, wf%n_v, wf%n_v)
!
      call dgemm('T', 'N', &
         wf%n_v**2, &
         wf%n_v, &
...
!
      ...
      call add_1324_to_1234(one, X724, omega_bjck, wf%n_o, wf%n_v, wf%n_o, wf%n_v)
      call mem%dealloc(X724)
      call mem%alloc(X725, wf%n_v, wf%n_o, wf%n_v, wf%n_o)
!
      call dgemm('N', 'T', &
         wf%n_v, &
         wf%n_v*wf%n_o**2, &
         ...
         wf%n_v)
!
      call mem%alloc(X726, wf%n_v, wf%n_o, wf%n_o, wf%n_v)
      call sort_to_1243(X725, X726, wf%n_v, wf%n_o, wf%n_v, wf%n_o)
      call mem%dealloc(X725)
      call mem%alloc(X727, wf%n_o, wf%n_o, wf%n_v)
      call sort_to_132(tAxxx_ovo, X727, wf%n_o, wf%n_v, wf%n_o)
      call mem%alloc(X728, wf%n_o, wf%n_o, wf%n_v, wf%n_o, wf%n_o)
!
      call dgemm('N', 'T', &
         wf%n_o**2, &
         wf%n_v*wf%n_o**2, &
...
!
      ...
      call mem%alloc(X729, wf%n_o, wf%n_o, wf%n_v)
      call sort_to_132(tAxxx_ovo, X729, wf%n_o, wf%n_v, wf%n_o)
...
!
      ...
      call add_1324_to_1234(one, X730, omega_bjck, wf%n_o, wf%n_v, wf%n_o, wf%n_v)
...
!
   end subroutine omega_μ2_4_s_ccsd
